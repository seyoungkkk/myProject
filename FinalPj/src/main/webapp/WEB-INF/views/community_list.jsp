			...
			<div class="sticky">
				<div class="horizontal-header clearfix ">
					<div class="container">
						...
						<a href="tel:245-6325-3256" class="callusbtn"><i class="fa fa-phone" ></i></a>
					</div>
				</div>
			</div>
			<!-- Mobile Header -->
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-12">
								...
								<ul class="payments mb-0">
									<li>
										<a href="javascript:;" class="payments-icon"><i class="fa fa-cc-amex" ></i></a>
									</li>
									<li>
										<a href="javascript:;" class="payments-icon"><i class="fa fa-cc-visa" ></i></a>
									</li>
									<li>
										<a href="javascript:;" class="payments-icon"><i class="fa fa-credit-card-alt" ></i></a>
									</li>
									<li>
										<a href="javascript:;" class="payments-icon"><i class="fa fa-cc-mastercard" ></i></a>
									</li>
									<li>
										<a href="javascript:;" class="payments-icon"><i class="fa fa-cc-paypal" ></i></a>
									</li>
								</ul>
							</div>
						</div>
