						...
						<nav class="horizontalMenu clearfix d-md-flex">
							<ul class="horizontalMenu-list">
								...
								<li aria-haspopup="true" class="d-lg-none mt-5 pb-5 mt-lg-0">
									<span><a class="btn btn-secondary" href="#">Browse Icon</a></span>
								</li>
							</ul>
							<ul class="mb-0">
							...
							<div class="row">
								...
								<div class="col-sm-12 col-md-6" >
									<div id="example_filter" class="dataTables_filter" style="text-align:right;">
										<label>Search:<input type="search" placeholder="">
										</label>
									</div>
								</div>
								</div>
								<table class="table table-bordered ico-listing text-nowrap dataTable no-footer" role="grid">
									<thead>
										<tr class="border-bottom text-center" role="row">
											<th class="font-weight-bold sorting_desc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="번호: activate to sort column ascending" style="width: 84px;" aria-sort="descending">번호</th>
											<th class="wd-15p sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Last name: activate to sort column ascending">분류</th>
											...
											<th class="font-weight-bold">비추</th>
										</tr>
									</thead>
									<tbody>
										<tr class="border-bottom text-center">
											<td>1</td>
											<td>결제</td>
											<td><a href="community_notice_content">결제 방식이 변경됩니다.</a></td>
											<td>관리자</td>
											<td>2020.01.27</td>
											<td>213</td>
											<td>3</td>
										...
										<tr class="border-bottom">
											<td>Monero</td>
											<td><img src="../images/crypto-currencies/monero.svg" alt="" class="w-7 h-7"></td>
											<td>
										...
										<tr class="border-bottom">
											<td>TRON</td>
											<td><img src="../images/crypto-currencies/tron.svg" alt="" class="w-7 h-7"></td>
											<td>
												<div class="rating-stars">
											...
											<td>Cloud Storage</td>
											<td class="text-red">$1423</td>
											<td class="">$65.21.456</td>
											<td>19Th Apr 2019</td>
											<td class=""><a href="ico.html" class="btn btn-primary">View Details</a></td>
										</tr>
										<tr class="border-bottom">
											<td>Bitcoin Gold</td>
											<td><img src="../images/crypto-currencies/bitcoinglod.svg" alt="" class="w-7 h-7"></td>
											<td>
												<div class="rating-stars">
													<input type="number" readonly="readonly" class="rating-value star" name="rating-stars-value"  value="1">
													<div class="rating-stars-container">
										...
										<tr class="border-bottom">
											<td>Bitcoin</td>
											<td><img src="../images/crypto-currencies/bitcoin.svg" alt="Bitcoin" class="w-7 h-7"></td>
											<td>
												<div class="rating-stars">
													<input type="number" readonly="readonly" class="rating-value star" name="rating-stars-value"  value="2">
													<div class="rating-stars-container">
										...
										<tr class="border-bottom">
											<td>Ethereum</td>
											<td><img src="../images/crypto-currencies/ethereum.svg" alt="Ethereum" class="w-7 h-7"></td>
											<td>
												<div class="rating-stars">
													<input type="number" readonly="readonly" class="rating-value star" name="rating-stars-value"  value="1">
													<div class="rating-stars-container">
										...
										<tr class="border-bottom">
											<td>Ripple</td>
											<td><img src="../images/crypto-currencies/ripple.svg" alt="Ripple" class="w-7 h-7"></td>
											<td>
												<div class="rating-stars">
													<input type="number" readonly="readonly" class="rating-value star" name="rating-stars-value"  value="2">
													<div class="rating-stars-container">
											...
											<td>Marketing</td>
											<td class="text-red">$25</td>
											<td class="">$6,65,452</td>
											<td>21st Jan 2019</td>
											<td class=""><a href="ico.html" class="btn btn-primary">View Details</a></td>
										</tr>
										<tr class="border-bottom">
											<td>Bitcoin Cash</td>
											<td><img src="../images/crypto-currencies/bitcoincash.svg" alt="Bitcoin" class="w-7 h-7"></td>
											<td>
												<div class="rating-stars">
										...
										<tr class="border-bottom">
											<td>Cardano</td>
											<td><img src="../images/crypto-currencies/cardano.svg" alt="Cardano" class="w-7 h-7"></td>
											<td>
												<div class="rating-stars">
										...
										<tr class="border-bottom">
											<td>Litecoin</td>
											<td><img src="../images/crypto-currencies/litecoin.svg" alt="Litecoin" class="w-7 h-7"></td>
											<td>
												<div class="rating-stars">
										...
										<tr class="border-bottom">
											<td>EOS</td>
											<td><img src="../images/crypto-currencies/eos.svg" alt="EOS" class="w-7 h-7"></td>
											<td>
												<div class="rating-stars">
													<input type="number" readonly="readonly" class="rating-value star" name="rating-stars-value"  value="4">
													<div class="rating-stars-container">
										...
										<tr class="border-bottom">
											<td>NEM</td>
											<td><img src="../images/crypto-currencies/nem.svg" alt="NEM" class="w-7 h-7"></td>
											<td>
												<div class="rating-stars">
													<input type="number" readonly="readonly" class="rating-value star" name="rating-stars-value"  value="3">
													<div class="rating-stars-container">
										...
										<tr class="border-bottom">
											<td>Stellar</td>
											<td><img src="../images/crypto-currencies/stellar.svg" alt="Bitcoin" class="w-7 h-7"></td>
											<td>
												<div class="rating-stars">
													<input type="number" readonly="readonly" class="rating-value star" name="rating-stars-value"  value="5">
													<div class="rating-stars-container">
										...
										<tr class="border-bottom">
											<td>NEO</td>
											<td><img src="../images/crypto-currencies/neo.svg" alt="Bitcoin" class="w-7 h-7"></td>
											<td>
												<div class="rating-stars">
													<input type="number" readonly="readonly" class="rating-value star" name="rating-stars-value"  value="3">
													<div class="rating-stars-container">
										...
										<tr class="border-bottom">
											<td>IOTA</td>
											<td><img src="../images/crypto-currencies/iota.svg" alt="Bitcoin" class="w-7 h-7"></td>
											<td>
												<div class="rating-stars">
													<input type="number" readonly="readonly" class="rating-value star" name="rating-stars-value"  value="4">
													<div class="rating-stars-container">
								...
								<br/>
									...
									<div class="col-md-4">
										<ul class="pagination mg-b-0 page-0 " style="align:center;">
											<li class="page-item">
