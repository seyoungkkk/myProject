							...
							<!-- 	<ul class="tabs-menu nav">
									...
									<div class="tab-content">
										...
										<div class="item-card7-desc">
											<span class="fa fa-briefcase"><strong>&nbsp;프로젝트 번호</strong></span>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<span>112233</span>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<span style='text-align:right;'><i class="si si-user text-muted mr-1" ></i><strong> 담당자 이름</strong></span>
											<span>&nbsp;&nbsp;&nbsp;&nbsp;김당당</span><br/>
											<br/>								
											<span class="fa fa-briefcase font-weight-semibold"><strong>&nbsp;프로젝트이름</strong></span>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<span>프로젝트이름프로젝트프로젝트</span>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<div class="item-card7-desc"> 
										...
										<div class="card-header">
											...
											<center>
											<a href="payments_end.do" class="btn2 btn-primary">결제</a>
											</center>
										</div>				
									</div>
								</div>
